...
export class ICHICHAIN__ICHISeriesResult {
  value0: string;
  value1: BigInt;
  value2: BigInt;
  value3: BigInt;
...
export class ICHICHAIN__currencyListResult {
  value0: Address;
  value1: Address;
  value2: BigInt;
  value3: i32;
...
export class ICHICHAIN__getSubPrizesDetailResultValue0Struct extends ethereum.Tuple {
  get subPrizeID(): BigInt {
...
export class ICHICHAIN__ticketStatusDetailResult {
  value0: BigInt;
  value1: BigInt;
  value2: boolean;
  value3: boolean;
...
export class ICHICHAIN extends ethereum.SmartContract {
  static bind(address: Address): ICHICHAIN {
    return new ICHICHAIN("ICHICHAIN", address);
  }
  ...
  ICHISeries(param0: BigInt): ICHICHAIN__ICHISeriesResult {
    let result = super.call(
      "ICHISeries",
    ...
    return new ICHICHAIN__ICHISeriesResult(
      result[0].toString(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toBigInt(),
  ...
  try_ICHISeries(
    param0: BigInt,
  ): ethereum.CallResult<ICHICHAIN__ICHISeriesResult> {
    let result = super.tryCall(
      "ICHISeries",
      "ICHISeries(uint256):(string,uint256,uint256,uint256,bool,uint256,uint256,string,string,string,string,uint256,bool,bool)",
      [ethereum.Value.fromUnsignedBigInt(param0)],
    ...
    return ethereum.CallResult.fromValue(
      new ICHICHAIN__ICHISeriesResult(
        value[0].toString(),
        value[1].toBigInt(),
        value[2].toBigInt(),
        value[3].toBigInt(),
  ...
  currencyList(param0: BigInt): ICHICHAIN__currencyListResult {
    let result = super.call(
      "currencyList",
    ...
    return new ICHICHAIN__currencyListResult(
      result[0].toAddress(),
      result[1].toAddress(),
      result[2].toBigInt(),
      result[3].toI32(),
  ...
  try_currencyList(
    param0: BigInt,
  ): ethereum.CallResult<ICHICHAIN__currencyListResult> {
    let result = super.tryCall(
      "currencyList",
      "currencyList(uint256):(address,address,uint256,uint8)",
      [ethereum.Value.fromUnsignedBigInt(param0)],
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new ICHICHAIN__currencyListResult(
        value[0].toAddress(),
        value[1].toAddress(),
        value[2].toBigInt(),
        value[3].toI32(),
  ...
  getSubPrizesDetail(
    seriesID: BigInt,
  ): Array<ICHICHAIN__getSubPrizesDetailResultValue0Struct> {
    let result = super.call(
      "getSubPrizesDetail",
    ...
    return result[0].toTupleArray<ICHICHAIN__getSubPrizesDetailResultValue0Struct>();
  }
  ...
  > {
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      value[0].toTupleArray<ICHICHAIN__getSubPrizesDetailResultValue0Struct>(),
    );
  }
  ...
  ticketStatusDetail(param0: BigInt): ICHICHAIN__ticketStatusDetailResult {
    let result = super.call(
      "ticketStatusDetail",
    ...
    return new ICHICHAIN__ticketStatusDetailResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBoolean(),
      result[3].toBoolean(),
  ...
  try_ticketStatusDetail(
    param0: BigInt,
  ): ethereum.CallResult<ICHICHAIN__ticketStatusDetailResult> {
    let result = super.tryCall(
      "ticketStatusDetail",
      "ticketStatusDetail(uint256):(uint256,uint256,bool,bool)",
      [ethereum.Value.fromUnsignedBigInt(param0)],
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new ICHICHAIN__ticketStatusDetailResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBoolean(),
        value[3].toBoolean(),
