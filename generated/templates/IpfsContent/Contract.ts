...
export class Contract__getSubPrizesDetailResultValue0Struct extends ethereum.Tuple {
  get subPrizeID(): BigInt {
...
export class Contract extends ethereum.SmartContract {
  ...
  getSubPrizesDetail(
    seriesID: BigInt,
  ): Array<Contract__getSubPrizesDetailResultValue0Struct> {
    let result = super.call(
      "getSubPrizesDetail",
    ...
    return result[0].toTupleArray<Contract__getSubPrizesDetailResultValue0Struct>();
  }
  ...
  > {
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      value[0].toTupleArray<Contract__getSubPrizesDetailResultValue0Struct>(),
    );
  }
